...
data.results.forecast.forEach(function(day){
    console.log("Today is " + day.day + ". The high is " + day.high + ". The low is " + day.low + ". It will be " + day.text)
});
...
for(var i = 0; i < myJSON.people.length; i++) {
    console.log("Full Name: " + textParsed.employees[i].firstName + " " + textParsed.employees[i].lastName + ",\nJob: " + myJSON.people[i].job);
}
